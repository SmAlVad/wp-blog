...
if ( ! function_exists( 'lalita_add_footer_info' ) ) {
	...
	function lalita_add_footer_info() {
		echo '<span class="copyright">&copy; ' . esc_html( date( 'Y' ) ) . ' ' . esc_html( get_bloginfo( 'name' ) ) . '</span> &bull; ' . esc_html__( 'Powered by', 'lalita' ) . ' <a href="' . esc_url( LALITA_THEME_URL ) . '" itemprop="url">' . esc_html__( 'WPKoi', 'lalita' ) . '</a>';
	}
}
