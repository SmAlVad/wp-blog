				...
				<div class="lalita-masthead clearfix">
					<div class="lalita-container">
						<div class="lalita-title">
							<a href="<?php echo esc_url(LALITA_THEME_URL); ?>" target="_blank"><?php esc_html_e( 'Lalita', 'lalita' ); ?></a> <span class="lalita-version"><?php echo esc_html( LALITA_VERSION ); ?></span>
						</div>
						<div class="lalita-masthead-links">
							<?php if ( ! defined( 'LALITA_PREMIUM_VERSION' ) ) : ?>
								<a class="lalita-masthead-links-bold" href="<?php echo esc_url(LALITA_THEME_URL); ?>" target="_blank"><?php esc_html_e( 'Premium', 'lalita' );?></a>
							<?php endif; ?>
